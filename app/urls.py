...
from .views.lead_views import LeadCreateView, LeadAssignmentView, LeadHistoryView, LeadDetailHistoryView
...
urlpatterns = [
    ...
    path('org/leads/<str:lead_id>/lead-history/', LeadDetailHistoryView.as_view(), name='lead-history'),
